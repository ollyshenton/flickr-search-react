      ...
      <div className="flex flex-wrap -mx-5 overflow-hidden sm:-mx-5 md:-mx-5 lg:-mx-4 xl:-mx-16">
        {images.photo.map(item => {
          return (
            <div
              key={item.id}
              className="my-5 px-5 w-full overflow-hidden sm:my-5 sm:px-5 sm:w-1/2 md:my-5 md:px-5 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/2 xl:my-8 xl:px-8 xl:w-1/4   flex flex-col "
            >
              <img
